    ...
    <header>
        <Card>
            ...
            <div className="flex flex-col gap-6 grow">
                ...
                <a href={profileData.workUrl} className="flex items-center text-xs gap-1.5 font-medium py-1.5 px-3 rounded-xl bg-green-700/20 dark:bg-green-800/40 text-green-600 dark:text-green-200 opacity-80 transition-opacity duration-150 hover:opacity-100" target="_blank" aria-label='Link to Linkedin profile'>
                ...
                <h1 className="text-neutral-800 dark:text-neutral-200 text-3xl font-semibold">{profileData.name}</h1>
                <p className="text-neutral-600 dark:text-neutral-400 text-sm">{profileData.description}</p>
                </div>
                ...
                <div className="flex flex-col gap-4 md:flex-row justify-between">
                    ...
                    <a href={`mailto:${profileData.contactEmail}`} target="_blank" className="inline-flex items-center text-sm justify-center rounded-xl bg-neutral-200 dark:bg-neutral-800 dark:hover:text-neutral-50 py-2 px-4 opacity-80 transition-opacity duration-150 hover:opacity-100 w-full md:w-auto group gap-1 font-medium" aria-label='Link to email'>
                    Contact
