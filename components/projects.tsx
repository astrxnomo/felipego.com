...
export default async function Projects () {
  ...
  return (
    <Card>
      ...
      <a href="https://github.com/astrxnomo" target="_blank" className="inline-flex items-center text-sm justify-center rounded-xl bg-neutral-200 dark:bg-neutral-800 py-2 px-4 opacity-80 transition-opacity duration-150 hover:opacity-100 w-full md:w-auto group gap-2 font-medium" aria-label='Explore more projects'>
        More projects
  ...
  return (
    <div className="flex flex-col gap-3 rounded-xl p-4 hover:bg-neutral-300/20 dark:hover:bg-neutral-800/20 duration-100">
      ...
      <div className="flex gap-2 mt-1">
        {githubLink &&
          <a href={githubLink} className="inline-flex items-center justify-center rounded-xl bg-neutral-300/60 dark:bg-neutral-800 p-2 opacity-80 transition-opacity duration-150 hover:opacity-100 grow" target="_blank" aria-label='Link to Github repository'>
            <Github className="size-4"/>
          </a>
        }
        {previewLink &&
          <a href={previewLink} className="inline-flex items-center justify-center rounded-xl bg-neutral-300/60 dark:bg-neutral-800 p-2 opacity-80 transition-opacity duration-150 hover:opacity-100 grow" target="_blank" aria-label='Link to live preview'>
