  ...
  return (
    <li className="ms-3 p-4 rounded-xl hover:bg-neutral-300/20 dark:hover:bg-neutral-800/20 duration-100">
      ...
      <div className="mt-2 flex flex-col space-y-0.5">
        ...
        <a href={companyUrl} target="_blank" className="text-sm font-medium duration-150 text-neutral-700 dark:text-neutral-400 opacity-80 hover:opacity-100" aria-label='Link to company site'>
